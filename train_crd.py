...
from timm.loss import JsdCrossEntropy, SoftTargetCrossEntropy, BinaryCrossEntropy, LabelSmoothingCrossEntropy, knowledge_distillation_kl_div_loss, CRDLoss
...
def main():
    ...
    if torch.cuda.is_available():
        ...
        #启用 cuDNN 的 benchmark 模式。该模式可以根据输入大小自动选择最合适的卷积算法，从而提升性能
